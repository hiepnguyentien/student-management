...
INSERT INTO subject_class (subject_class_id, subject_id, lecturer_id)
VALUES
    (nextval('subject_class_sequence'), 1, 1),
    (nextval('subject_class_sequence'), 1, 1),
    (nextval('subject_class_sequence'), 2, 2),
    (nextval('subject_class_sequence'), 4, 2),
    (nextval('subject_class_sequence'), 4, 3),
    (nextval('subject_class_sequence'), 6, 3),
    (nextval('subject_class_sequence'), 7, 4),
    (nextval('subject_class_sequence'), 6, 4),
    (nextval('subject_class_sequence'), 7, 5),
    (nextval('subject_class_sequence'), 6, 5),
    (nextval('subject_class_sequence'), 7, 6),
    (nextval('subject_class_sequence'), 7, 6),
    (nextval('subject_class_sequence'), 1, 7),
    (nextval('subject_class_sequence'), 9, 8),
    (nextval('subject_class_sequence'), 2, 7),
    (nextval('subject_class_sequence'), 3, 8),
    (nextval('subject_class_sequence'), 5, 8),
    (nextval('subject_class_sequence'), 7, 8),
    (nextval('subject_class_sequence'), 10, 1);
